...
typeof b;a.safeMode=c?b:!0;a=p;c=p.domElementTypes;b=["*"];t(c)?(c=c.split(y.space),0===c.length&&(c=b)):c=D(c)?c:b;a.domElementTypes=c}var u=null,z=null,y={empty:""},e={},p={};this.addObservableObject=function(a,b){return A(a,b)};this.setConfiguration=function(a){p=q(a)?a:{};G();return this};this.getVersion=function(){return"0.1.0"};(function(a,b){u=a;z=b;G();u.addEventListener("DOMContentLoaded",function(){for(var c=p.domElementTypes,d=c.length,g=0;g<d;g++){var k=u.getElementsByTagName(c[g]);k=
[].slice.call(k);for(var h=k.length,l=0;l<h;l++){var f=k[l],m=!0;if(n(f)&&f.hasAttribute("data-observe-options")){var r=f.getAttribute("data-observe-options");t(r)?(r=x(r),r.parsed&&q(r.result)?(r=C(r.result),t(f.id)||(f.id=B()),A(f,r,f.id)):p.safeMode||(console.error("The attribute 'data-observe-options' is not a valid object."),m=!1)):p.safeMode||(console.error("The attribute 'data-observe-options' has not been set correctly."),m=!1)}if(!m)break}}});n(z.$observe)||(z.$observe=this)})(document,window)})();