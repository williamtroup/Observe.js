...
(function(){function N(){for(var a=g.domElementTypes,b=a.length,c=0;c<b;c++){var f=B.getElementsByTagName(a[c]);f=[].slice.call(f);for(var h=f.length,l=0;l<h;l++){var k=f[l],v=!0;if(r(k)&&k.hasAttribute("data-observe-watch-options")){var e=k.getAttribute("data-observe-watch-options");m(e)?(e=D(e),e.parsed&&t(e.result)?(e=O(e.result),m(k.id)||(k.id=P()),e.removeAttribute&&k.removeAttribute("data-observe-watch-options"),Q(k,e,k.id)):(J(g.attributeNotValidErrorText.replace("{{attribute_name}}","data-observe-watch-options")),
v=!1)):(J(g.attributeNotSetErrorText.replace("{{attribute_name}}","data-observe-watch-options")),v=!1)}if(!v)break}}}function Q(a,b,c){var f=null;if(t(a)){f=P();var h=O(b);b={};b.options=h;b.totalChanges=0;if(m(c)){if(a=B.getElementById(c),r(a)){b.domElementId=c;b.cachedObject=a.outerHTML;var l=b.originalObject=a.outerHTML}}else b.cachedObject=w.stringify(a),l=b.originalObject=a;r(b.cachedObject)&&(u(b.options.onStart,l),b.timer=setInterval(function(){var k=f,v=new Date;if(!E(h.starts)||v>=h.starts){if(d.hasOwnProperty(k)){var e=
