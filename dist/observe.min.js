...
e=!1)):q.safeMode||(console.error("The attribute 'data-observe-watch-options' has not been set correctly."),e=!1)}if(!e)break}}}function L(a,b,c){var f=null;if(t(a)){f=K();var k=J(b);b={};b.options=k;b.totalChanges=0;p(c)?(a=y.getElementById(c),r(a)&&(b.domElementId=c,b.cachedObject=a.outerHTML,b.originalObject=a.outerHTML)):(b.cachedObject=JSON.stringify(a),b.originalObject=a);b.timer=setInterval(function(){var h=f,l=new Date;if(!B(k.starts)||l>=k.starts){if(d.hasOwnProperty(h)){var e=d[h],g=p(e.domElementId),
...
e.options.propertyNames[n];if(g[M]!==m[M]){u(e.options.onChange,g,m);break}}else u(e.options.onChange,g,m);D(e.options.onPropertyChange)&&N(g,m,e)}e.totalChanges++;0<e.options.pauseTimeoutOnChange&&E(h,e.options.pauseTimeoutOnChange);e.options.cancelOnChange&&x(h);0<e.options.maximumChangesBeforeCanceling&&e.totalChanges>=e.options.maximumChangesBeforeCanceling&&x(h)}}B(k.expires)&&l>=k.expires&&x(h)}},k.timeout);d[f]=b}return f}function N(a,b,c){for(var f in a)if(a.hasOwnProperty(f)){var k=a[f],
h=null;b.hasOwnProperty(f)&&(h=b[f]);t(k)&&t(h)?N(k,h,c.options):(!w(c.options.propertyNames)||-1<c.options.propertyNames.indexOf(f))&&JSON.stringify(k)!==JSON.stringify(h)&&u(c.options.onPropertyChange,f,k,h)}}function O(){for(var a in d)d.hasOwnProperty(a)&&x(a)}function x(a){if(d.hasOwnProperty(a)){var b=d[a].options;if(b.allowCanceling||P)u(b.onCancel,a),clearTimeout(d[a].timer),delete d[a]}}function E(a,b){var c=!1;if(d.hasOwnProperty(a)){var f=d[a].options;f.allowPausing&&(f.starts=new Date,
f.starts.setMilliseconds(f.starts.getMilliseconds()+b),c=!0)}return c}function J(a){a=t(a)?a:{};a.timeout=H(a.timeout,250);var b=a;var c=a.starts;c=B(c)?c:null;b.starts=c;b=a;c=a.expires;c=B(c)?c:null;b.expires=c;a.reset=z(a.reset,!1);a.cancelOnChange=z(a.cancelOnChange,!1);a.maximumChangesBeforeCanceling=H(a.maximumChangesBeforeCanceling,0);a.pauseTimeoutOnChange=H(a.pauseTimeoutOnChange,0);b=a;c=a.propertyNames;c=w(c)?c:null;b.propertyNames=c;a.allowCanceling=z(a.allowCanceling,!0);a.allowPausing=
z(a.allowPausing,null);a.onChange=F(a.onChange,null);a.onPropertyChange=F(a.onPropertyChange,null);a.onCancel=F(a.onCancel,null);a.onRemove=F(a.onRemove,null);return a}function u(a){D(a)&&a.apply(null,[].slice.call(arguments,1))}function K(){for(var a=[],b=0;32>b;b++){8!==b&&12!==b&&16!==b&&20!==b||a.push("-");var c=Math.floor(16*Math.random()).toString(16);a.push(c)}return a.join(C.empty)}function r(a){return null!==a&&void 0!==a&&a!==C.empty}function t(a){return r(a)&&"object"===typeof a}function p(a){return r(a)&&
