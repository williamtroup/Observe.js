...
(function(){function G(a,b,c){var f=null;if(r(a)){f=H();var d=I(b);b={};b.options=d;b.domElementId=c;b.totalChanges=0;t(c)?(a=v.getElementById(c),p(a)&&(b.cachedObject=a.outerHTML,b.originalObject=a.outerHTML)):(b.cachedObject=JSON.stringify(a),b.originalObject=a);b.timer=setInterval(function(){var k=new Date;if(!x(d.starts)||k>=d.starts){var u=f;if(h.hasOwnProperty(u)){var g=h[u],e=t(g.domElementId),m=null;e&&(m=v.getElementById(g.domElementId),p(m)&&(g.originalObject=m.outerHTML));var l=g.cachedObject,
n=g.originalObject,y=e?n:JSON.stringify(n);l!==y&&(n=g.options,n.reset?e?m.outerHTML=g.cachedObject:g.originalObject=z(l).result:g.cachedObject=y,e?A(n.onChange,l,y):(e=z(l).result,m=z(y).result,A(n.onChange,e,m),B(n.onPropertyChange)&&!J(e)&&K(e,m,n)),n.cancelOnChange&&w(u),g.totalChanges++,0<n.maximumChangesBeforeCanceling&&g.totalChanges>=n.maximumChangesBeforeCanceling&&w(u))}x(d.expires)&&k>=d.expires&&w(f)}},d.observeTimeout);h[f]=b}return f}function K(a,b,c){for(var f in a)if(a.hasOwnProperty(f)){var d=
a[f],k=null;b.hasOwnProperty(f)&&(k=b[f]);r(d)&&r(k)?K(d,k,c):JSON.stringify(d)!==JSON.stringify(k)&&A(c.onPropertyChange,f,d,k)}}function w(a){h.hasOwnProperty(a)&&(A(h[a].options.onCancel,a),clearTimeout(h[a].timer),delete h[a])}function I(a){var b=a=r(a)?a:{};var c=a.observeTimeout;c=L(c)?c:250;b.observeTimeout=c;b=a;c=a.starts;c=x(c)?c:null;b.starts=c;b=a;c=a.expires;c=x(c)?c:null;b.expires=c;a.reset=C(a.reset,!1);a.cancelOnChange=C(a.cancelOnChange,!1);b=a;c=a.maximumChangesBeforeCanceling;c=
...
b=!0;break}return b};this.getWatch=function(a){var b=null;h.hasOwnProperty(a)&&(b=h[a]);return b};this.setConfiguration=function(a){q=r(a)?a:{};M();return this};this.getVersion=function(){return"0.2.0"};(function(a,b){v=a;F=b;M();v.addEventListener("DOMContentLoaded",function(){for(var c=q.domElementTypes,f=c.length,d=0;d<f;d++){var k=v.getElementsByTagName(c[d]);k=[].slice.call(k);for(var u=k.length,g=0;g<u;g++){var e=k[g],m=!0;if(p(e)&&e.hasAttribute("data-observe-options")){var l=e.getAttribute("data-observe-options");
t(l)?(l=z(l),l.parsed&&r(l.result)?(l=I(l.result),t(e.id)||(e.id=H()),G(e,l,e.id)):q.safeMode||(console.error("The attribute 'data-observe-options' is not a valid object."),m=!1)):q.safeMode||(console.error("The attribute 'data-observe-options' has not been set correctly."),m=!1)}if(!m)break}}});p(F.$observe)||(F.$observe=this)})(document,window)})();