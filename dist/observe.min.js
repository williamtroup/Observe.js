...
!0;else for(var c in d)if(d.hasOwnProperty(c)&&t(d[c].domElementId)&&d[c].domElementId===a){v(c);b=!0;break}return b};this.cancelWatches=function(){for(var a in d)d.hasOwnProperty(a)&&v(a);return this};this.getWatch=function(a){var b=null;if(d.hasOwnProperty(a))b=d[a];else for(var c in d)if(d.hasOwnProperty(c)&&t(d[c].domElementId)&&d[c].domElementId===a){b=d[c];break}return b};this.getWatches=function(){return d};this.setConfiguration=function(a){q=r(a)?a:{};M();return this};this.getVersion=function(){return"0.3.0"};
...
q.safeMode||(console.error("The attribute 'data-observe-options' has not been set correctly."),n=!1)}if(!n)break}}});p(G.$observe)||(G.$observe=this)})(document,window)})();