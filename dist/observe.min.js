...
n=h.originalObject,y=f?n:JSON.stringify(n);l!==y&&(n=h.options,n.reset?f?m.outerHTML=h.cachedObject:h.originalObject=z(l).result:h.cachedObject=y,f?A(n.onChange,l,y):(f=z(l).result,m=z(y).result,A(n.onChange,f,m),B(n.onPropertyChange)&&!J(f)&&K(f,m,n)),n.cancelOnChange&&w(u),h.totalChanges++,0<n.maximumChangesBeforeCanceling&&h.totalChanges>=n.maximumChangesBeforeCanceling&&w(u))}x(e.expires)&&k>=e.expires&&w(g)}},e.observeTimeout);d[g]=b}return g}function K(a,b,c){for(var g in a)if(a.hasOwnProperty(g)){var e=
a[g],k=null;b.hasOwnProperty(g)&&(k=b[g]);r(e)&&r(k)?K(e,k,c):JSON.stringify(e)!==JSON.stringify(k)&&A(c.onPropertyChange,g,e,k)}}function w(a){d.hasOwnProperty(a)&&(A(d[a].options.onCancel,a),clearTimeout(d[a].timer),delete d[a])}function I(a){var b=a=r(a)?a:{};var c=a.observeTimeout;c=L(c)?c:250;b.observeTimeout=c;b=a;c=a.starts;c=x(c)?c:null;b.starts=c;b=a;c=a.expires;c=x(c)?c:null;b.expires=c;a.reset=C(a.reset,!1);a.cancelOnChange=C(a.cancelOnChange,!1);b=a;c=a.maximumChangesBeforeCanceling;c=
...
"string"===typeof a}function B(a){return p(a)&&"function"===typeof a}function L(a){return p(a)&&"number"===typeof a}function J(a){return r(a)&&a instanceof Array}function x(a){return r(a)&&a instanceof Date}function C(a,b){return p(a)&&"boolean"===typeof a?a:b}function D(a,b){return B(a)?a:b}function z(a){var b=!0,c=null;try{t(a)&&(c=JSON.parse(a))}catch(g){try{c=eval("("+a+")"),B(c)&&(c=c())}catch(e){b=N("Errors in object: "+g.message+", "+e.message),c=null}}return{parsed:b,result:c}}function N(a){var b=
!0;q.safeMode||(console.error(a),b=!1);return b}function M(){q.safeMode=C(q.safeMode,!0);var a=q,b=q.domElementTypes,c=["*"];t(b)?(b=b.split(E.space),0===b.length&&(b=c)):b=J(b)?b:c;a.domElementTypes=b}var v=null,F=null,E={empty:""},d={},q={};this.watchObject=function(a,b){return G(a,b)};this.cancelWatch=function(a){var b=!1;if(d.hasOwnProperty(a))w(a),b=!0;else for(var c in d)if(d.hasOwnProperty(c)&&t(d[c].domElementId)&&d[c].domElementId===a){w(c);b=!0;break}return b};this.getWatch=function(a){var b=
null;if(d.hasOwnProperty(a))b=d[a];else for(var c in d)if(d.hasOwnProperty(c)&&t(d[c].domElementId)&&d[c].domElementId===a){b=d[c];break}return b};this.setConfiguration=function(a){q=r(a)?a:{};M();return this};this.getVersion=function(){return"0.2.0"};(function(a,b){v=a;F=b;M();v.addEventListener("DOMContentLoaded",function(){for(var c=q.domElementTypes,g=c.length,e=0;e<g;e++){var k=v.getElementsByTagName(c[e]);k=[].slice.call(k);for(var u=k.length,h=0;h<u;h++){var f=k[h],m=!0;if(p(f)&&f.hasAttribute("data-observe-options")){var l=
