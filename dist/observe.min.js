...
(function(){function H(a,b,c){var h=null;if(r(a)){h=I();var e=J(b);b={};b.options=e;b.domElementId=c;b.totalChanges=0;t(c)?(a=v.getElementById(c),p(a)&&(b.cachedObject=a.outerHTML,b.originalObject=a.outerHTML)):(b.cachedObject=JSON.stringify(a),b.originalObject=a);b.timer=setInterval(function(){var l=new Date;if(!x(e.starts)||l>=e.starts){var u=h;if(d.hasOwnProperty(u)){var k=d[u],f=t(k.domElementId),n=null;f&&(n=v.getElementById(k.domElementId),p(n)&&(k.originalObject=n.outerHTML));var m=k.cachedObject,
g=k.originalObject,y=f?g:JSON.stringify(g);m!==y&&(g=k.options,g.reset?f?n.outerHTML=k.cachedObject:k.originalObject=z(m).result:k.cachedObject=y,f?A(g.onChange,m,y):(f=z(m).result,n=z(y).result,A(g.onChange,f,n),B(g.onPropertyChange)&&!K(f)&&L(f,n,g)),0<g.pauseTimeoutOnChange&&(g.starts=new Date,g.starts.setMilliseconds(g.starts.getMilliseconds()+g.pauseTimeoutOnChange)),g.cancelOnChange&&w(u),k.totalChanges++,0<g.maximumChangesBeforeCanceling&&k.totalChanges>=g.maximumChangesBeforeCanceling&&w(u))}x(e.expires)&&
l>=e.expires&&w(h)}},e.timeout);d[h]=b}return h}function L(a,b,c){for(var h in a)if(a.hasOwnProperty(h)){var e=a[h],l=null;b.hasOwnProperty(h)&&(l=b[h]);r(e)&&r(l)?L(e,l,c):JSON.stringify(e)!==JSON.stringify(l)&&A(c.onPropertyChange,h,e,l)}}function w(a){d.hasOwnProperty(a)&&(A(d[a].options.onCancel,a),clearTimeout(d[a].timer),delete d[a])}function J(a){a=r(a)?a:{};a.timeout=C(a.timeout,250);var b=a;var c=a.starts;c=x(c)?c:null;b.starts=c;b=a;c=a.expires;c=x(c)?c:null;b.expires=c;a.reset=D(a.reset,
